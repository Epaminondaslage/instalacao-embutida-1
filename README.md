...
### Guia de Aula – Instalação Elétrica em Box Didático – Desenho, Diagrama Unifilar e Execução

## Objetivos da Aula

Ao final desta atividade, o aluno será capaz de:

- Representar graficamente eletrodutos, caixas e pontos de utilização em planta baixa.  
- Interpretar e elaborar diagramas unifilares conforme os elementos da instalação elétrica.  
...
- 01 **interruptor paralelo** comandando:  
  - a arandela  
...
- Sistema monofásico  
- Tensão: **127 V**  
- Potência das lâmpadas: **7 W cada**
...
- Na luminária (arandela)  
- Nos interruptores (paralelos e intermediário)  
- Na TUG de uso geral  
